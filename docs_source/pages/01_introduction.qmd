...
### Beyond the Horizon: How Space Exploration Drives Scientific Innovation and Economic Growth {.unnumbered .unlisted}

::: {.callout-note appearance="simple"}
This title will be moved to the index page after the grading of Lab 0.
::: 
...
![The 5 overarching perspectives of the project.](../images/big_picture_chart.jpg){#fig-big-picture}
...
![The NASA Curiosity Rover. Source: @nasa_curiosity_nodate](../images/nasa_curiosity.jpg){#fig-nasa-curiosity}
...
![Crowds watch SpaceX Falcon Heavy boosters land on Tuesday, Feb. 6, 2018 in Cape Canaveral. Source: @herrera_space_2019](../images/cape_canaveral_crowds.jpg){#fig-cape-canaveral-crowds}
...
![Artist's impression of satellites and debris on orbit around Earth. Source: @european_space_agency_debris_2008](../images/esa_satellites.jpg){#fig-esa-satellites}
...
![SpaceX's launch from the Kennedy Space Center’s Launch Complex 39A. Source: @spacex_mission_nodate](../images/spacex_kennedy.jpg){#fig-spacex-kennedy}
...
![The International Space Station is widely regarded as a symbol of international scientific collaboration. Source: @nasa_international_nodate](../images/iss.jpg){#fig-iss}
