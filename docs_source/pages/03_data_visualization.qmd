...
IFrame(src='../../docs_source/images/results/stocks_crossover_plot_with_candlesticks_with_dropdown.html', width=width_percentage, height=570)
```
...
width_percentage = "100%"
IFrame(src='../../docs_source/images/launches_per_country_of_launch_site.html', width=width_percentage, height=570)
```
...
width_percentage = "100%"
IFrame(src='../../docs_source/images/cumulative_launches_spacex_vs_others.html', width=width_percentage, height=570)
```
...
![Shows the weather satellite launches per year hued by status](../../docs_source/images/oscar_satellites_status.jpeg){#fig-weather-satellite-launches}
